<?php
    ...
    if(isset($_POST['check_result_btn'])){
        ...
        if(empty($result_regno)){
            $msg = "Error! Registration Number is Required";
        }
        elseif($result_class == $select){
            $msg = "Error! Please Select Class to check Result";
        }
        elseif($result_term == $select){
            $msg = "Error! Please Select the term for the Result";
        }
        elseif(empty($result_pin)){
            $msg = "Error! Please Type in Card Pin to Access your Result";
        }
        else{
