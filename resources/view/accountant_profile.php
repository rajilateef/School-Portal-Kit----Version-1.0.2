<div class="row user">
  <div class="col-md-12">
    <div class="profile">
      <div class="info"><img class='img-circle' src='../../img/avatar.jpg' alt='User Image'>
        <h4><?php echo $accountant_name; ?></h4>
        <p>Accountant</p>
      </div>
        ...
        <div class="timeline">
          <div class="post">
            <div class="post-media"><a href="#"></a>
              <div class="content">
                <h5><a href="#">Phone: <?php echo $accountant_phone; ?></a></h5>
                <h5><a href="#">Email: <?php echo $accountant_email; ?></a></h5>
                <h5><a href="#">Address: <?php echo $accountant_address; ?></a></h5>
