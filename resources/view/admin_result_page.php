            ...
            <div class='container' id='result_page'>
                ...
                <div class='container'>
                    ...
                    <div class='col-md-6 col-xs-6'>
                        ...
                        <p class='grade'><b>Class Roll Call:</b> Present: <?php echo $times_present; ?> times &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Absent: <?php echo $times_absent; ?> times </p>
                    </div>
                            ...
                            <table class='table table-bordered'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $third_term_promotion; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <a href='modules.php?view_published_result' class='btn btn-danger btn-sm noprint'><i class='fa fa-close'> Cancel</i></a>
                <br />
                <br />
            </div>
        </div>
