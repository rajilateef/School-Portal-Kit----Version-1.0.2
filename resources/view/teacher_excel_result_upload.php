   ...
   <?php
    ...
    <div class='panel panel-primary'>
        ...
        <div class='panel-body'>
            ...
            <form method='POST' action='teacher_PHPExcel.php'>
                <div class='row'>
                    <div class='col-md-3'>
    ...
    <div class='panel panel-primary'>
        ...
        <div class='panel-body'>
            ...
            <form method='POST' action='teacher_result_upload_excel.php' enctype="multipart/form-data">
                <div class='row'>
                   <div class='col-md-3'>
                        <div class='input-group'>
                ...
                <div class='row'>
                   <div class='col-md-3'>
                    ...
                    <div class='col-md-2'>
                        <input type='submit' name='teacher_upload_excel_result_btn' value='UPLOAD RESULT' class='btn btn-primary' />
                    </div>
                </div>
            </form>
            <br />
