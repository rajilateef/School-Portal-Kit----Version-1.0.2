   ...
   <?php
    ...
    <div class='panel panel-primary'>
        ...
        <div class='panel-body'>
            ...
            <form method='POST' action='upload_excel_conduct.php' enctype="multipart/form-data">
                <div class='row'>
                   <div class='col-md-3'>
                ...
                <div class='row'>
                    <div class='col-md-2'>
                        <input type='submit' name='upload_excel_conduct_btn' value='UPLOAD' class='btn btn-primary' />
                    </div>
                </div>
            </form>
            <br />
